...
export default class DevToolBar extends React.Component<DefaultProps, Props, State> {
  ...
  render() {
    return (
      <div style={{display: 'flex', justifyContent: 'center', alignItems: 'stretch', height: '65px', backgroundColor: '#0f1319', overflowY: 'visible', flexDirection: 'column'}}>
        <div style={{position: 'relative', top: '-20px', overflowY: 'visible'}}>
