...
export default class DevToolBar extends React.Component<DefaultProps, Props, State> {
  ...
  render() {
    return (
      <div className="dev-tool-bar-background-color" style={{display: 'flex', justifyContent: 'center', alignItems: 'stretch', height: '55px', overflowY: 'visible', flexDirection: 'column'}}>
