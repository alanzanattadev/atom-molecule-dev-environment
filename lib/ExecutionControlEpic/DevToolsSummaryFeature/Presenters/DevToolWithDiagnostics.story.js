...
storiesOf('DevToolWithDiagnostics', module)
  ...
  .add('Many', () => (
    <div style={{display: 'flex'}}>
      <DevToolWithDiagnostics name="nightwatch" iconUri="devtool-icon-nightwatch.png" warnings={2} errors={5} infos={2} successes={6}/>
      <DevToolWithDiagnostics name="gulp" iconUri="devtool-icon-gulp.svg" warnings={2} errors={5} infos={2} successes={6}/>
      <DevToolWithDiagnostics name="chrome" iconUri="devtool-icon-chrome.png" warnings={2} errors={5} successes={6} state="running"/>
      <DevToolWithDiagnostics name="redux" iconUri="devtool-icon-redux.png"/>
      <DevToolWithDiagnostics name="npm" iconUri="devtool-icon-npm.svg" errors={5} successes={6} state="running"/>
      <DevToolWithDiagnostics name="jest" iconUri="devtool-icon-jest.png" warnings={2} errors={5} infos={2}/>
      <DevToolWithDiagnostics name="webpack" iconUri="devtool-icon-webpack.png" infos={2}/>
      <DevToolWithDiagnostics name="docker" iconUri="devtool-icon-docker.png" warnings={2} errors={5} infos={2} successes={6}/>
    </div>
  ))
