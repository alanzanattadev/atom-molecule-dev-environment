...
export default class DevToolsWithDiagnostics extends React.Component<DefaultProps, Props, State> {
  ...
  render() {
    return (
      <ul style={{display: 'flex', flex: '1', flexDirection: 'row', paddingLeft: '0px', margin: '5px 0px', overflowX: 'auto', overflowY: 'visible', justifyContent: 'center', alignItems: 'center'}}>
        {this.props.tools.map(tool => (
          <li key={tool.id} style={{listStyle: 'none', margin: '0px'}}>
