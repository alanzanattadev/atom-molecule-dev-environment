  ...
  render() {
    return (
      <div
        ...
        style={{position: 'relative', width: `${this.props.size + this.props.circleSize}px`, height: `${this.props.circleSize * 4 + 10}px`, justifyContent: 'center', alignItems: 'center', flexDirection: 'column', display: 'flex', flexShrink: '0', overflow: 'hidden'}}
      >
        {
          [
