...
describe("DevToolWithDiagnostics", () => {
  ...
  it("should display tool icon with one blue / red circle if errors and info exist", () => {
    let subject = mount(
      <DevToolWithDiagnostics info={2} errors={5} warning={0} />,
    );
  ...
  it("should display tool icon with blue / red / yellow / green circle if every diagnostic exist", () => {
    let subject = mount(
      <DevToolWithDiagnostics info={2} errors={5} warnings={1} successes={5} />,
    );
  ...
  //   let subject = mount(<DevToolWithDiagnostics info={2} errors={5} name="gulp"/>);
  //
  ...
  it("should call onDiagnosticClick with diagnostic type on diagnostic circle click", () => {
    let spy = jest.fn();
    let subject = mount(
      <DevToolWithDiagnostics info={2} errors={5} onDiagnosticClick={spy} />,
    );
  ...
  it("should call onLogsClick on devtool icon click", () => {
    let spy = jest.fn();
    let subject = mount(
      <DevToolWithDiagnostics info={2} errors={5} onLogsClick={spy} />,
    );
  ...
  //   let spy = jest.fn();
  //   let subject = mount(<DevToolWithDiagnostics info={2} errors={5} onSettingsClick={spy}/>);
  //
  //   subject.simulate('mouseenter');
