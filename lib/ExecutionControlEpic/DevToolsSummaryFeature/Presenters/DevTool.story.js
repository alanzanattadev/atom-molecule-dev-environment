...
storiesOf("DevTool", module)
  .add("Basic", () => (
    <div style={{ padding: "30", height: '200px', display: 'flex', alignItems: 'flex-end', marginLeft: '100px' }}>
  ...
  .add("Color", () => (
    <div style={{ padding: "30", height: '200px', display: 'flex', alignItems: 'flex-end', marginLeft: '100px' }}>
      <DevTool iconUri="devtool-icon-docker.png" state="running" color="#836BEB"/>
    </div>
  ))
  .add("Show Color", () => (
    <div style={{ padding: "30", height: '200px', display: 'flex', alignItems: 'flex-end', marginLeft: '100px' }}>
      <DevTool iconUri="devtool-icon-docker.png" state="running" color="#836BEB" showColor legend="Server"/>
    </div>
  ))
