  ...
  render() {
    return (
      <div onClick={this.props.onClick} style={{
        ...
        {
          this.state.hovered ?
          (<Image fallbackImage="diagnostic-icon-log.svg" src="atom://molecule-dev-environment/.storybook/public/diagnostic-icon-log.svg" style={{transition: 'all 0.2s', height: this.props.size, width: this.props.size}}/>) :
