...
export default class PlanConfigGroup extends React.Component<DefaultProps, Props, State> {
  ...
  render() {
    return (
      <div className="plan-background-color" style={{display: 'flex', flexDirection: 'column', padding: '10px', alignItems: 'stretch', margin: '5px 5px 5px 0px', borderRadius: '5px'}}>
