...
export default class PlanConfigConditionalGroup
  ...
  getConfigPart() {
    if (this.props.value.expressionValue == null) return null;
    let matchingCase = this.props.cases[this.props.value.expressionValue];
    if (matchingCase == null) return null;
    else
      return (
        <PlanConfigPart
          {...matchingCase}
          value={this.props.value.caseValue}
          onChange={value =>
            this.props.onChange({
              expressionValue: this.props.value.expressionValue,
              caseValue: value,
            })}
        />
      );
        ...
        <PlanConfigPart
          ...
          onChange={value =>
            this.props.onChange({
              ...
              caseValue: getDefault(this.props.cases[value] || {}),
            })}
        />
        {this.getConfigPart()}
      </div>
