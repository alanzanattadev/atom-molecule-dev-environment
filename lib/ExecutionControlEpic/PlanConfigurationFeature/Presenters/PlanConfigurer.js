...
export default function PlanConfigurer(
  ...
  return (
    <ConfigurerBox>
      <PlanConfigTextInputField label="name" name="name" />
      <SectionTitle>Action</SectionTitle>
      <PlanConfigPart {...config} name="config" />
      ...
      <PackageConfig name="packageInfos" packages={packages} />
      <SectionTitle>Stager</SectionTitle>
      <Explanation>
        A stager is a way for controlling how your plan will be executed by
        Molecule.
        <br />
        RECOMMENDED: By default, integrated, means it will be executed in Atom.
        <br />
      ...
      <StagerConfig name="stager" />
      <ButtonPositioner>
        <AddButton onClick={onSubmit} success>
          Create
        </AddButton>
      </ButtonPositioner>
    </ConfigurerBox>
