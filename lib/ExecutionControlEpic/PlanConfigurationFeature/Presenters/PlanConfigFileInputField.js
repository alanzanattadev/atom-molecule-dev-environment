...
import { findFiles } from "../Actions/FindFiles";
...
export class PlanConfigFileInputField
  ...
  componentDidMount() {
    this.props.dispatch(findFiles(this.props.tester, this.props.title));
  }
...
export default connect()(PlanConfigFileInputField);
