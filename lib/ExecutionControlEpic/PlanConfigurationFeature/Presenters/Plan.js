...
export class Plan extends React.Component<DefaultProps, Props, State> {
  ...
  render() {
    return (
      <div
        ...
        <span className="text-color-highlight" style={{margin: '0px 15px', fontSize: '20px', fontFamily: 'Inconsolata'}}>{this.props.name}</span>
        {
          this.props.pinnable ?
