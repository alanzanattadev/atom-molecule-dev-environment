...
import PlansWithTasks from "../../TaskExecutionFeature/Presenters/PlansWithTasks";
    ...
    return (
      <div style={{position: 'relative', minHeight: '300px', display: 'flex', alignitems: 'stretch', flex: '1'}}>
        ...
        <div style={{marginTop: '20px', display: 'flex', flexDirection: 'column', alignitems: 'center', flex: '1'}}>
          <PlansWithTasks onPlanClick={this.props.onPlanClick} onTaskClick={this.props.onTaskClick} plansWithTasks={this.props.plansWithTasks}/>
