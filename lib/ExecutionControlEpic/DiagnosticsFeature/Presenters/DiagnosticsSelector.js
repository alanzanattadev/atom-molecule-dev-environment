...
export default class DiagnosticSelector extends React.Component<DefaultProps, Props, State> {
  ...
  render() {
    ...
    return (
      <div className={{className: getColorForDiagnosticType(this.props.type)}} style={{display: 'inline-flex', opacity: this.props.selected ? '1' : '0.5', flexWrap: 'nowrap', margin: '5px 5px', height: '35px', borderRadius: '4px'}}>
        {
          this.props.of > 1 ? (
        ...
        <div
          className={{className: (this.props.of > 1 && getDarkColorForDiagnosticType(this.props.type))}}
        ...
        >
          <span style={{color: '#fff', whiteSpace: 'nowrap', fontSize: '14px'}}>
            {
              this.props.of > 1 ?
