...
export default class DiagnosticSelector extends React.Component<DefaultProps, Props, State> {
  ...
  render() {
    ...
    return (
      <div style={{display: 'inline-flex', opacity: this.props.selected ? '1' : '0.5', flexWrap: 'nowrap', margin: '5px 5px', height: '35px', borderRadius: '4px', backgroundColor: getColorForDiagnosticType(this.props.type)}}>
        {
          this.props.of > 1 ? (
