...
describe("DiagnosticsSelectors", () => {
  it(
    "should display warnings and errors when there is no infos and successes",
    () => {
      ...
      expect(subject.find(DiagnosticsSelector).at(1).prop("type")).toBe(
        "error",
      );
    },
  );
  ...
  it(
    "should display infos and successes when there is no warnings and errors",
    () => {
      let diagnostics: Array<Diagnostic> = [
        {
          type: "info",
  ...
  it(
    "should call onSelected with type and index when a back arrow is clicked",
    () => {
      let diagnostics: Array<Diagnostic> = [
        {
          type: "info",
  ...
  it(
    "should call onSelected with type and index when a forward arrow is clicked",
    () => {
      let diagnostics: Array<Diagnostic> = [
        {
          type: "info",
  ...
  it(
    "should call onSelected with type and index when a selector is clicked",
    () => {
      let diagnostics: Array<Diagnostic> = [
        {
          type: "info",
