...
describe('DiagnosticsSelector', () => {
  ...
  it('should call onBack on back arrow click', () => {
    let spy = jest.fn();
    let subject = mount(<DiagnosticsSelector index={1} of={4} type="warning" onBack={spy}/>);
  ...
  it('should call onForward on forward arrow click', () => {
    let spy = jest.fn();
    let subject = mount(<DiagnosticsSelector index={1} of={4} type="warning" onForward={spy}/>);
  ...
  it('should call onClick on number click', () => {
    let spy = jest.fn();
    let subject = mount(<DiagnosticsSelector index={1} of={4} type="warning" onClick={spy}/>);
