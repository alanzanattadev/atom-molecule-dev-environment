...
describe('DiagnosticsSelector', () => {
  it('should display only 1 if one diagnostic of type exists', () => {
    let subject = shallow(<DiagnosticsSelector index={0} of={1} type="warning"/>);

    expect(subject.text()).toBe('1');
    expect(subject.find(Arrow).length).toBe(0);
  });

  it('should display index and total diagnostics number of type with arrows', () => {
    let subject = shallow(<DiagnosticsSelector index={1} of={4} type="warning"/>);
  ...
  it('should call onBack on back arrow click', () => {
    let spy = jest.fn();
    let subject = shallow(<DiagnosticsSelector index={1} of={4} type="warning" onBack={spy}/>);
  ...
  it('should call onForward on forward arrow click', () => {
    let spy = jest.fn();
    let subject = shallow(<DiagnosticsSelector index={1} of={4} type="warning" onForward={spy}/>);
  ...
  it('should call onClick on number click', () => {
    let spy = jest.fn();
    let subject = shallow(<DiagnosticsSelector index={1} of={4} type="warning" onClick={spy}/>);
