...
import type {Question as QuestionType, Step as StepType} from '../Types/types.js.flow';
...
export default Radium((
  ...
  <Frame height={frameHeight} tabIndex="1">
    ...
    <span className="icon icon-remove-close" style={{position: 'absolute', right: '5px', top: '5px', cursor: 'pointer'}} onClick={onEscape}></span>
