...
export default class TargetConfigPanel extends React.Component<DefaultProps, Props, State> {
  ...
  render() {
    return (
      <div key={this.props.toolId} style={{height: '230px', overflow: 'auto', display: 'flex', justifyContent: 'center', alignItems: 'stretch', flex: '1'}}>
        <div style={{display: 'flex', flex: '1', alignItems: 'stretch', flexDirection: 'column', overflow: 'auto'}}>
          <DevToolTargets {...this.props} pinnable/>
        </div>
        <div style={{flex: '1', display: 'flex', justifyContent: 'center', alignItems: 'stretch', overflow: 'auto'}}>
