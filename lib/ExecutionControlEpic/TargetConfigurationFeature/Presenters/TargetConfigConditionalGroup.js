...
export default class TargetConfigConditionalGroup extends React.Component<DefaultProps, Props, State> {
  ...
  getConfigPart() {
    ...
    if (matchingCase == null)
      ...
      // $FlowFixMe
      return <TargetConfigPart {...matchingCase} value={this.props.value.caseValue} onChange={value => this.props.onChange({expressionValue: this.props.value.expressionValue, caseValue: value})}/>
  }
...
TargetConfigConditionalGroup.propTypes = {

};

TargetConfigConditionalGroup.defaultProps = {
  onChange: () => {},
