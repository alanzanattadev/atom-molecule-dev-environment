      ...
      <Tasks
        tasks={[
          { state: "running", debut: moment().subtract(1, "minutes").unix() },
          {
            ...
            end: moment().subtract("2", "s").unix(),
            selected: true
          },
          {
            state: "crashed",
            debut: moment().subtract(6, "minutes").unix(),
            end: moment().subtract("3", "s").unix()
          },
          {
            state: "stopped",
            debut: moment().subtract(7, "minutes").unix(),
            end: moment().subtract("2", "s").unix()
          },
          {
            state: "stopped",
            debut: moment().subtract(8, "minutes").unix(),
