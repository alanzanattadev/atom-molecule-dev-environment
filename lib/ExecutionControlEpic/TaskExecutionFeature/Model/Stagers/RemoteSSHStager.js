...
import type {Stager} from "../../../TargetConfigurationFeature/Types/types.js";
...
export default function RemoteSSHStagerConfigurer(config: Stager) {
  return function(strategy: Strategy, controller: Controller): ?Process {
    let child = fork(__dirname + '/../../Process/SSHProcess.js', [JSON.stringify(config.host), JSON.stringify(strategy)], {silent: true, env: Object.assign({}, process.env, {
      BABEL_ENV: 'process'
    })});
