...
import type {StopTaskOfTargetAction} from "../Actions/StopTaskOfTarget";
import {stopTaskOfTarget} from "../Actions/StopTaskOfTarget";


describe('Tasks Reducer', () => {
  describe('ADD_TASK', () => {
    it('should add a task', () => {
      let action: AddTaskAction = addTask("1", {config: 2, stager: {type: 'integrated', host: null},  tool: {id: "3", name: "tool", iconUri: ""}}, {type: "integrated"}, 1475954335);
  ...
  describe('STOP_TASK_OF_TARGET', () => {
    it('should mark the task as stopped', () => {
      let action: StopTaskOfTargetAction = stopTaskOfTarget({config: 2, stager: {type: 'integrated', host: null},  tool: {id: '2', name: 'tool', iconUri: ""}, state: 'running'}, 1475954336);
      let state: TasksReducer = [{
        id: "1",
        state: "created",
        debut: 1475954335,
