    ...
    return new Promise((resolve, reject) => {
      ...
      if (devtool) {
        ...
        if (execConfig.controller.watchFiles) {
          // const fileWatcher = execConfig.controller.watchFiles();
          connection.sendNotification("watcher/watch", {
            settings: execConfig.controller.watchFiles.settings,
          });
        }

        const taskAPI = PluginApi(connection.sendNotification);
        const helperAPI = {};
        ...
        if (runner != null) {
          ...
          runner.connection.onRequest("window/showMessageRequest", data => {
            return connection.sendRequest("window/showMessageRequest", data);
          });
          ...
          runner.connection.onRequest("client/registerCapability", data => {
            return connection.sendRequest("client/registerCapability", data);
          });
          runner.connection.onRequest("client/unregisterCapability", data => {
            return connection.sendRequest("client/unregisterCapability", data);
          });
          ...
          connection.onNotification("workspace/didChangeWatchedFiles", data => {
            runner.connection.sendNotification(
          ...
          connection.onRequest("workspace/symbol", data => {
            return runner.connection.sendRequest("workspace/symbol", data);
          });
          ...
          connection.onNotification("textDocument/didOpen", data => {
            runner.connection.sendNotification("textDocument/didOpen", data);
          });
          connection.onNotification("textDocument/didChange", data => {
            runner.connection.sendNotification("textDocument/didChange", data);
          });
          connection.onNotification("textDocument/willSave", data => {
            runner.connection.sendNotification("textDocument/willSave", data);
          });
          ...
          connection.onNotification("textDocument/didSave", data => {
            runner.connection.sendNotification("textDocument/didSave", data);
          });
          connection.onNotification("textDocument/didClose", data => {
            runner.connection.sendNotification("textDocument/didClose", data);
          });
          ...
          connection.onRequest("textDocument/hover", data => {
            return runner.connection.sendRequest("textDocument/hover", data);
          });
          ...
          connection.onRequest("textDocument/codeLens", data => {
            return runner.connection.sendRequest("textDocument/codeLens", data);
          });
          connection.onRequest("codeLens/resolve", data => {
            return runner.connection.sendRequest("codeLens/resolve", data);
          });
          ...
          connection.onRequest("documentLink/resolve", data => {
            return runner.connection.sendRequest("documentLink/resolve", data);
          });
          connection.onRequest("textDocument/rename", data => {
            return runner.connection.sendRequest("textDocument/rename", data);
          });
        }
      } else {
        config.actions.kill();
