...
export default {
  config: {
    ...
    freeTerminal: {
      type: "boolean",
      description:
        "Activate/Desactivate Molecule's terminal ( you need to refresh or restart Atom to apply any of the changes on the settings)",
      default: true,
    },
    pinnedPlans: {
      type: "boolean",
      description: "Activate/Desactivate Molecule's pinned plans",
      default: true,
    },
    moleculeConsole: {
      type: "boolean",
      description: "Activate/Desactivate Molecule's console",
      default: true,
    },
    moleculeLinter: {
      type: "boolean",
      description: "Activate/Desactivate Linter in Molecule",
      default: true,
    },
    plugins: {
      type: "object",
      properties: {
        Docker: {
          type: "boolean",
          description: "Activate/Desactivate Docker in Molecule",
          default: true,
        },
        Eslint: {
          type: "boolean",
          description: "Activate/Desactivate Eslint in Molecule",
          default: true,
        },
        Cpp: {
          type: "boolean",
          description: "Activate/Desactivate Cpp in Molecule",
          default: true,
        },
        Nightwatch: {
          type: "boolean",
          description: "Activate/Desactivate Nightwatch in Molecule",
          default: true,
        },
        Flowtype: {
          type: "boolean",
          description: "Activate/Desactivate Flowtype in Molecule",
          default: true,
        },
        Gulp: {
          type: "boolean",
          description: "Activate/Desactivate Gulp in Molecule",
          default: false,
        },
        Jest: {
          type: "boolean",
          description: "Activate/Desactivate Jest in Molecule",
          default: true,
        },
        Npm: {
          type: "boolean",
          description: "Activate/Desactivate Npm in Molecule",
          default: true,
        },
        Shell: {
          type: "boolean",
          description: "Activate/Desactivate Shell in Molecule",
          default: true,
        },
        Testcafe: {
          type: "boolean",
          description: "Activate/Desactivate Testcafe in Molecule",
          default: true,
        },
      },
    },
