...
import {getBasename, getExtension, getAssociatedFiles} from './AssociatedFiles';
...
describe('AssociatedFiles', () => {
  ...
  describe('getAssociatedFiles', () => {
    it('should return test and story associated with .js', () => {
      ...
      expect(subject).toEqual(['/home/alan/myfile.test.js', '/home/alan/myfile.story.js'])
    });

    it('should return test and .js associated with story', () => {
      let subject = getAssociatedFiles("/home/alan/myfile.story.js");

      expect(subject).toEqual(['/home/alan/myfile.test.js', '/home/alan/myfile.js'])
    });
  });
});
