...
import autoLaunchPlansEpic from "./AutoLaunchPlans";
...
describe("AutoLaunch Epic", () => {
  ...
  beforeEach(() => {
    const epicAutoLaunchPlans = createEpicMiddleware(autoLaunchPlansEpic);
  ...
  it("should do nothing without autoLaunch", () => {
