...
export class DraggableRemote extends React.Component<DefaultProps, Props, State> {
  state: State;
  props: Props;
...
function getActionName(sourceItem: BranchType, targetRemote: RemoteType, type: string): ?string {
